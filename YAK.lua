...
NameBot = (DevALS:get(YAK..'ALS:NameBot') or 'دراكون')
--     Source YAK     --
...
YAK = 'مبـرمج دراكون' elseif tonumber(user_id) == tonumber(YAK) then 
...
if text and text:match('^'..(DevALS:get(YAK..'ALS:NameBot') or "دراكون")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevALS:get(YAK..'ALS:NameBot') or "دراكون")..' ','')
end
...
if text and text == (DevALS:get(YAK..'ALS:NameBot') or 'دراكون') then 
local YAK = {"❤️‍🔥","🏌🏼","🦋","🍧","🥲","🍇","🥲♥️","♥️","🍧🍇",""} 
local YAK = YAK[math.random(#YAK)]
NameBot = (DevALS:get(YAK..'ALS:NameBot') or 'دراكون')
local namebot = {
...
Dev_ALS(msg.chat_id_, msg.id_, 1, 'مبرمج دراكون اهينك ما اهينه😏🖕🏿', 1, 'md')
return false  
end  
if result.id_ then  
...
.."☆︙عدد السبام ↫ "..spam_c.."\n"
.."ꔹ┉ ┉ ┉ 𝙔𝘼𝙆┉ ┉ ┉ ┉ꔹ \n"
local inline = {{{text="🖥┇𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐑𝐀𝐆𝐎𝐍 .",url="t.me/YAK_TEAM"}}}
fucktele =  msg.id_/2097152/0.5
...
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙جاري تحديث سورس دراكون', 1, 'md') 
